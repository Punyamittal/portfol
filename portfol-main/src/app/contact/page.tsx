        ...
        <form action="#" className="space-y-8">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              id="message"
              rows={6}
              className="block p-2.5 w-full text-sm text-black-900 bg-black-50 rounded-lg shadow-sm border border-black-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-black-700 dark:border-black-600 dark:placeholder-black-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
